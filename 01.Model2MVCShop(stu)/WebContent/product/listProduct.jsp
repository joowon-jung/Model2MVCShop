...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
	<%
		if(searchVO.getSearchCondition() != null) { // 검색 한 적이 있으면
	%>	
		<td align="right">
			<select name="searchCondition" class="ct_input_g" style="width:80px">
		<%
				if(searchVO.getSearchCondition().equals("0")){ // 상품번호로 눌려져 있었으면
		%>
				<option value="0" selected>상품번호</option>
				<option value="1">상품명</option>
				<option value="2">상품가격</option>
		<%
				}else if(searchVO.getSearchCondition().equals("1")){ // 상품명이 눌려져 있었으면
		%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		<td align="center">
			...
			%>
			<!-- 각각 페이지를 누를 때 마다 클라이언트의 요청이 들어왔다고 이해. 그러므로 Action 각각 수행 -->
