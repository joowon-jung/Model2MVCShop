...
<%
	// CheckDuplicationAction 에서 아이디 중복체크 한 결과값 (true/false)을 가져옴 
	boolean result=false; // 중복 아님 
...
function fncCheckDuplication() {
	...
	if(document.detailForm.userId.value != null && document.detailForm.userId.value.length >0) {
	    ...
	    document.detailForm.action='/checkDuplication.do'; // 중복확인 하기 위해 URL 이동
