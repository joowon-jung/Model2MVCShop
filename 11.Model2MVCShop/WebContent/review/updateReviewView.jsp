...
<div class="container">
		...
		<div class="page-header">
	       <h1 class="text-center">REVIEW UPDATE</h1>
	    </div>
		...
		<div class="row">
			...
			<input		type="text" name="contents" 	class="form-control"
							style="width: 600px; height: 100px" maxLength="500" value="${ review.contents }"/>
			</div>
		</div>
		...
		<div class="row">
	  		<div class="col-md-12 text-center ">
	  			...
	  			<button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target=".modal">확인</button>	 
	  			&nbsp;&nbsp;&nbsp;&nbsp;
