...
<form name="updateReview" method="post" action="/updateReview.do">
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">상품평 수정</td>
...
<%-- 							style="width: 300px; height: 19px" maxLength="100" value="${ review.title }" /> --%>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input		type="text" name="contents" 	class="ct_input_g" 
							style="width: 300px; height: 100px" maxLength="500" value="${ review.contents }"/>
		</td>
	</tr>
</table>
